...
data class Attributes(
    ...
    val coverImage: data.model.CoverImage?,
    ...
    val posterImage: data.model.PosterImage?,
    @SerialName("ratingFrequencies")
    val ratingFrequencies: data.model.RatingFrequencies?,
